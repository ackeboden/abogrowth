  ...
  head: () => ({
    meta: [
      { title: "Prisuppskattning | ABO Growth" },
      {
        name: "description",
        content:
          "Få en ungefärlig prisbild direkt. Svara på några frågor om omfattning så räknar verktyget fram ett riktpris, och vad ett upplägg hos oss skulle kunna innehålla.",
      },
    ...
    <div className="min-h-screen bg-paper text-ink">
      ...
      <main>
        <PageHero
          ...
          title={<>Vad kostar det? <span className="text-brand-green-strong">Räkna själv.</span></>}
        ...
        <section className="border-b border-line">
          <div className="mx-auto max-w-6xl px-6 py-16 flex flex-wrap items-center justify-between gap-6">
            <Link to="/sa-gar-det-till" className="group inline-flex items-center gap-3 text-sm font-semibold">
              <span className="tracked text-xs text-ink/65">Vill ni hellre prata direkt?</span>
